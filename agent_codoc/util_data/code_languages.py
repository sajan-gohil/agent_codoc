CODE_LANGUAGES = [
    "abap", "abnf", "actionscript", "ada", "agda", "al", "antlr4",
    "apacheconf", "apex", "apl", "applescript", "aql", "arduino", "arff",
    "asciidoc", "asm6502", "asmatmel", "aspnet", "autohotkey", "autoit",
    "avisynth", "avroIdl (avro-idl)", "bash", "basic", "batch", "bbcode",
    "bicep", "birb", "bison", "bnf", "brainfuck", "brightscript", "bro", "bsl",
    "c", "cfscript", "chaiscript", "cil", "clike", "clojure", "cmake", "cobol",
    "coffeescript", "concurnas", "coq", "cpp", "crystal", "csharp", "cshtml",
    "csp", "cssExtras (css-extras)", "css", "csv", "cypher", "d", "dart",
    "dataweave", "dax", "dhall", "diff", "django",
    "dnsZoneFile (dns-zone-file)", "docker", "dot", "ebnf", "editorconfig",
    "eiffel", "ejs", "elixir", "elm", "erb", "erlang", "etlua",
    ...
    "hsts", "http", "ichigojam", "icon",
    "icuMessageFormat (icu-message-format)", "idris", "iecst", "ignore",
    "inform7", "ini", "io", "j", "java", "javadoc", "javadoclike",
    "javascript", "javastacktrace", "jexl", "jolie", "jq",
    ...
    "solidity", "solutionFile (solution-file)", "soy", "sparql",
    "splunkSpl (splunk-spl)", "sqf", "sql", "squirrel", "stan", "stylus",
    "swift", "systemd", "t4Cs (t4-cs)", "t4Templating (t4-templating)",
    "t4Vb (t4-vb)", "tap", "tcl", "textile", "toml", "tremor", "tsx", "tt2",
    "turtle", "twig", "typescript", "typoscript", "unrealscript", "uorazor",
    "uri", "v", "vala", "vbnet", "velocity", "verilog", "vhdl", "vim",
    "visualBasic (visual-basic)", "warpscript", "wasm", "webIdl (web-idl)",
    "wiki", "wolfram", "wren", "xeora", "xmlDoc (xml-doc)", "xojo", "xquery",
    "yaml", "yang", "zig"
]
