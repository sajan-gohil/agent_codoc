...
def initialize_db():
    ...
    cur.execute('''CREATE TABLE IF NOT EXISTS rag_documentation_database (
    ...
    cur.execute('''CREATE TABLE IF NOT EXISTS rag_qa_database (
                    rowid INTEGER PRIMARY KEY AUTOINCREMENT,
                    text TEXT,
                    timestamp unixepoch DEFAULT CURRENT_TIMESTAMP,
                    metadata BLOB,
    ...
    # conn.execute("DELETE FROM rag_documentation_database")
    # conn.execute("DELETE FROM rag_qa_database")
